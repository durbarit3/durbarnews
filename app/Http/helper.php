...
class Bengali
{
    ...
    // date titme
    public static $en_carbon_times = array('hours', 'ago','week','months','year','from now');
    public static $bn_carbon_time = array('ঘন্টা', 'পূর্বে','সপ্তাহ','মাস','বছর','পর');
    ...
    public static function bn_date_time($date_time)
    {
        ...
        // convert string
        $date_time = str_replace(self::$en_carbon_times, self::$bn_carbon_time, $date_time);
