...
@section('content')
  ...
  <section id="comment">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb no-margin" style="background-color: #f7f7f7;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 text-left">
                                        <div class="img_cont_national">
                                            <h4><a href="#" style="text-decoration: none;color: #000;">Lorem ipsum dolor sit amet consectetur.</a></h4>
                            ...
                            <div class="single-block-n">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="img_box_n">
                                            <a href="#">
                                                <img src="images/netflix-20200225162641.jpg" class="w-100" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                            ...
                            <div class="single-block-n">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="img_box_n">
                                            <a href="#">
                                                <img src="images/sui-cover-20200226093202.webp" class="w-100" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                            ...
                            <div class="single-block-n">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="img_box_n">
                                            <a href="#">
                                                <img src="images/samira-01-20200226132030.webp" class="w-100" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                            ...
                            <div class="single-block-n">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="img_box_n">
                                            <a href="#">
                                                <img src="images/mal-01-20200224205835.webp" class="w-100" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                    ...
                    <div class="row text-center">
                        <div class="col-sm-12">
                            <div class="heading-national text-left">
                                <h4 class="back-title">
                                    <span class="eee">Populer-Comment</span>
                                </h4>
                            </div>
                        </div>
                    </div>
