                    ...
                    <ul class="media-list">
                        ...
                        <li class="media">
                            <div class="media-left">
                                <span>{{++$key}}</span>
                                <a @if($lnews->post_type==2) href="{{url('/videodetails/'.$lnews->slug.'/'.$lnews->id)}}" @else href="{{url('details/'.$lnews->slug.'/'.$lnews->id)}}" @endif>
                                    <img src="{{asset('public/website/')}}/images/lazy_loader.png"
                                        data-src="{{asset('public/uploads/newspost/small/'.$lnews->image)}}" alt=""
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <ul class="media-list">
                        ...
                        <li class="media">
                            <div class="media-left">
                                <span>{{ ++$key }}</span>
                                <a @if($popular->post_type==2) href="{{url('/videodetails/'.$popular->slug.'/'.$popular->id)}}" @else href="{{url('details/'.$popular->slug.'/'.$popular->id)}}" @endif>
                                    <img src="{{asset('public/website/')}}/images/lazy_loader.png"
                                        data-src="{{asset('public/uploads/newspost/small/'.$popular->image)}}" alt=""
                                        class="lazy img-fluid">
