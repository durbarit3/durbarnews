                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="other_list">
                                                <ul>
                                                    <li><a href="{{url('/newsportal/ourteam/team')}}"><i class="fab fa-accessible-icon"></i> আমাদের টীম</a>
                                                    </li>
