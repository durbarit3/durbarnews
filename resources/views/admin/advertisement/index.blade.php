		...
		<section class="page_content">
			...
			<div class="panel mb-0">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel_title">
								<span class="panel_icon"><i class="fas fa-border-all"></i></span><span>All Advertisement</span>
							</div>
						</div>
						<div class="col-md-6 text-right">
							<div class="panel_title">
								<a href="{{route('admin.advertisement.create')}}" class="btn btn-success"><i class="fas fa-plus"></i></span> <span>Add Advertisement</span></a>
							</div>
						</div>
					</div>
				</div>
				<form action="{{url('admin/advertisement/multisoftdel')}}" method="post">
					@csrf
					<br>
					<button type="submit" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete All</button>
					<a href="{{route('admin.advertisement.deletead')}}" class="btn btn-success btn-sm"><i class="fa fa-recycle"></i> Restore</a>
							...
							<table id="dataTableExample1" class="table table-bordered table-striped table-hover mb-2">
								...
								<tbody>
									...
									<tr>
										...
										<td>
										 @if($data->status==1)
										 <a href="{{url('admin/advertisement/deactive/'.$data->id)}}" class="btn btn-sm btn-success"><i class="fas fa-thumbs-up"></i></a> |
										 @else
										 <a href="{{url('admin/advertisement/active/'.$data->id)}}" class="btn btn-sm btn-danger"><i class="fas fa-thumbs-down"></i></a> |
										 @endif

										 <a href="{{url('admin/advertisement/edit/'.$data->id)}}" class="btn btn-sm btn-info"><i class="fas fa-pencil-alt"></i></a> |
	                                       <a class="btn btn-sm btn-danger" href="{{url('admin/advertisement/softdelete/'.$data->id)}}" id="delete"><i class="fa fa-trash"></i> </a> |
										</td>
									</tr>
									@endforeach
